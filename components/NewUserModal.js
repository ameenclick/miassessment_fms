    ...
    return(
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="newUserModalLabel">Generate New Codes</h5>
            ...
            <div class="modal-body">
                ...
                <select name="franchise" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" onChange={(e) => {setChoosenfranchise(e.target.value)}}>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onClick={() => setProcess(!process)}>
                    <svg xmlns="http://www.w3.org/2000/svg" className={process? style.spinner: ""} width="16" height="16" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
                    ...
                    </svg>  {!process? "Generate": "Generating..."}
                </button>
            </div>
            </div>
        </div>
