...
export default function User(props){
    ...
    //If user details is updating set the consulation audio upload progress to zero(Starting)
    useEffect(() => {
        if(!edit)
        {
            ...
            <div className='row mt-1'>
                ...
                <div style={{height: "100%", width: "100%", overflowY: "scroll"}}>
                    ...
                    filter=="" || filter == user.franchiseCode?
                        ...
                        <td>
                            <a href={user.report_url} target="_blank" className='btn btn-outline-primary rounded-pill'>
                                Open
                            </a> &nbsp;
                            <a href={`${process.env.host}/report/${user.userCode}`} target="_blank" className='btn btn-outline-primary'>
