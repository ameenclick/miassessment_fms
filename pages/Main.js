...
function Main(){
    ...
    useEffect(() => {
        ...
        const getFranchises = async () => {
            try {
                ...
                isMounted && setFranchises(franchises.data)
            }
            catch (err){
                console.error(err)
            }
    ...
    return (
        ...
        <div>
            ...
            {dashboardClass ? <Dashboard userNo={users.length} franchiseCount={franchises.length} setfranchiseClass={setfranchiseClass} setdashboardClass={setdashboardClass} setuserClass={setuserClass}  franchises={franchises} User={user} />: 
